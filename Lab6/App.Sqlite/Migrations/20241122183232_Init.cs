    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LifeCycleCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    LifeCycleName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    LifeCycleDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationDetails = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssetCategoryCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    AssetCategoryDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SizeCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    SizeDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StatusCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    StatusDescription = table.Column<string>(type: "TEXT", maxLength: 155, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartyDetails = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssetSupertypeCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    AssetSupertypeDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    AssetCategoryCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssetTypeCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    AssetTypeDescription = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    AssetSupertypeCode = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherDetails = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
